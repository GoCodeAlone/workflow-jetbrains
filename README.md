...
| `wfctl` | Tool actions (validate, run, inspect, etc.) | `go install github.com/GoCodeAlone/workflow/cmd/wfctl@latest` |
| `workflow-lsp-server` | LSP features (autocomplete, hover, diagnostics) | `go install github.com/GoCodeAlone/workflow/cmd/workflow-lsp-server@latest` |
