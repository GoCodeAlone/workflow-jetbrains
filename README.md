...
This plugin targets **workflow engine v0.60.9+**. The bundled JSON schema and live templates are generated from the v0.60.9 registry.
...
| `wfctl` | Tool actions and MCP server | `go install github.com/GoCodeAlone/workflow/cmd/wfctl@v0.60.9` |
| `workflow-lsp-server` | LSP features (autocomplete, hover, diagnostics) | `go install github.com/GoCodeAlone/workflow/cmd/workflow-lsp-server@v0.60.9` |
