...
This plugin targets **workflow engine v0.84.2+**. The bundled JSON schema and live templates are generated from the v0.84.2 registry.
...
| `wfctl` | Tool actions and MCP server | `go install github.com/GoCodeAlone/workflow/cmd/wfctl@v0.84.2` |
| `workflow-lsp-server` | LSP features (autocomplete, hover, diagnostics) | `go install github.com/GoCodeAlone/workflow/cmd/workflow-lsp-server@v0.84.2` |
