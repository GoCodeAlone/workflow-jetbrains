...
This plugin targets **workflow engine v0.18.6+**. The bundled JSON schema and live templates are generated from the v0.18.6 registry.
...
| `wfctl` | Tool actions and MCP server | `go install github.com/GoCodeAlone/workflow/cmd/wfctl@v0.18.6` |
| `workflow-lsp-server` | LSP features (autocomplete, hover, diagnostics) | `go install github.com/GoCodeAlone/workflow/cmd/workflow-lsp-server@v0.18.6` |
